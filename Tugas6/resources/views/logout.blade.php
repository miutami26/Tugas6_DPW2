      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-5 text-center mx-auto">
            ...
            <p class="text-lead text-white">gunakan formulir ini untuk masuk atau membuat akun baru </p>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="col-xl-4 col-lg-5 col-md-7 mx-auto">
          <div class="card z-index-0">
            <div class="card-header text-center pt-4">
              ...
              <div class="col-3 me-auto px-8" >
                <a class="btn btn-outline-white w-100" href="javascript:;" >
                  <svg width="35px" height="32px" viewBox="0 0 64 64" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
              ...
              <form role="form text-left">
                ...
                <div class="form-check form-check-info text-left">
                  ...
                  <label class="form-check-label" for="flexCheckDefault">
                    Saya Setuju <a href="javascript:;" class="text-dark font-weight-bolder"> Syarat Dan Ketentuan</a>
                  </label>
                </div>
                <div class="text-center">
                  <button type="button" class="btn bg-gradient-dark w-100 my-4 mb-2">Daftar</button>
                </div>
                <p class="text-sm mt-3 mb-0">Sudah Memiliki Akun? <a href="javascript:;" class="text-dark font-weight-bolder">Masuk</a></p>
              </form>
            </div>
          </div>
        </div>
